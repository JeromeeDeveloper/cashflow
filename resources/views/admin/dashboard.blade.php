    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <p class="text-subtitle text-muted">System-wide metrics and quick actions</p>
            </div>
                                    ...
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0">342</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h5 class="mb-0 ms-3">Cashflow</h5>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <h5 class="mb-0">98</h5>
                                                    ...
                                                    <tr>
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <p class="font-bold ms-3 mb-0">Jane Doe</p>
                                                            </div>
                                                        </td>
                                                        <td class="col-auto">
                                                            <p class=" mb-0">Uploaded chart_of_accounts_2024.xlsx</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <p class="font-bold ms-3 mb-0">John Smith</p>
                                                            </div>
                                                        </td>
                                                        <td class="col-auto">
                                                            <p class=" mb-0">Approved cashflow for Jan 2024</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <div class="card">
                            <div class="card-body py-4 px-5">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3 name">
                                        <h5 class="font-bold">{{ Auth::user()->name ?? 'Admin' }}</h5>
